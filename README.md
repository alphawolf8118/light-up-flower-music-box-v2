...
-Potentially allowing the flower to function separately from the stem and music box using magnets
...
prototypes/              # Physical prototypes (v0, v1, v2)  
...
-Creating part list
-Refining the overall flower design
